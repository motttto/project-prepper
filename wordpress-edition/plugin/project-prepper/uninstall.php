...
if ( get_option( 'pp_delete_data_on_uninstall' ) ) {
	...
	foreach ( [ 'pp_collective_rentals_visible', 'pp_item_time_status', 'pp_rental_buffer_before', 'pp_rental_buffer_after', 'pp_rental_backfill_done', 'pp_features' ] as $pp_opt ) {
