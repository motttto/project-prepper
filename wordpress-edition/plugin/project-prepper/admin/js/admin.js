...
(function () {
	...
	function renderPlatform() {
		...
		var ACTIONS = {
			...
			agreement_created: __("created an agreement", "project-prepper"),
			agreement_updated: __("updated an agreement", "project-prepper"),
			agreement_opened: __("opened an agreement", "project-prepper"),
			agreement_activated: __("activated an agreement", "project-prepper"),
			agreement_signed: __("signed an agreement", "project-prepper"),
			agreement_declined: __("declined an agreement", "project-prepper"),
			agreement_revised: __("revised an agreement", "project-prepper"),
			agreement_terminated: __("terminated an agreement", "project-prepper"),
			agreement_deleted: __("deleted an agreement", "project-prepper"),
			category_merged: __("merged categories", "project-prepper"),
			...
			cost_item_created: __("added a cost item", "project-prepper"),
			cost_item_updated: __("updated a cost item", "project-prepper"),
			cost_item_deleted: __("deleted a cost item", "project-prepper"),
			decision_created: __("created a decision", "project-prepper"),
			decision_updated: __("updated a decision", "project-prepper"),
			decision_resolved: __("resolved a decision", "project-prepper"),
			decision_cancelled: __("cancelled a decision", "project-prepper"),
			decision_deleted: __("deleted a decision", "project-prepper"),
			decision_vote_cast: __("voted on a decision", "project-prepper"),
			file_attached: __("attached a file", "project-prepper"),
			file_updated: __("updated a file", "project-prepper"),
			file_detached: __("removed a file", "project-prepper"),
			impersonation_started: __("started viewing as another user", "project-prepper"),
			impersonation_stopped: __("stopped viewing as another user", "project-prepper"),
			inquiry_created: __("created an inquiry", "project-prepper"),
			inquiry_status_changed: __("changed an inquiry status", "project-prepper"),
			inquiry_converted: __("converted an inquiry", "project-prepper"),
			inquiry_to_project: __("turned an inquiry into a project", "project-prepper"),
			inquiry_deleted: __("deleted an inquiry", "project-prepper"),
			poll_created: __("created a poll", "project-prepper"),
			poll_updated: __("updated a poll", "project-prepper"),
			poll_closed: __("closed a poll", "project-prepper"),
			poll_reopened: __("reopened a poll", "project-prepper"),
			poll_deleted: __("deleted a poll", "project-prepper"),
			poll_vote_cast: __("voted in a poll", "project-prepper"),
			profit_share_added: __("added a profit share", "project-prepper"),
			profit_share_updated: __("updated a profit share", "project-prepper"),
			profit_share_removed: __("removed a profit share", "project-prepper"),
			project_created: __("created a project", "project-prepper"),
			project_updated: __("updated a project", "project-prepper"),
			project_deleted: __("deleted a project", "project-prepper"),
			project_status_changed: __("changed a project status", "project-prepper"),
			project_item_added: __("added equipment to a project", "project-prepper"),
			project_item_updated: __("updated project equipment", "project-prepper"),
			project_item_removed: __("removed equipment from a project", "project-prepper"),
			project_member_added: __("added a project member", "project-prepper"),
			project_member_updated: __("updated a project member", "project-prepper"),
			project_member_removed: __("removed a project member", "project-prepper"),
			project_task_created: __("added a task", "project-prepper"),
			project_task_updated: __("updated a task", "project-prepper"),
			project_task_deleted: __("deleted a task", "project-prepper"),
			project_checklist_created: __("added a checklist", "project-prepper"),
			project_checklist_updated: __("updated a checklist", "project-prepper"),
			project_checklist_deleted: __("deleted a checklist", "project-prepper"),
			project_checklist_item_added: __("added a checklist item", "project-prepper"),
			project_checklist_item_updated: __("updated a checklist item", "project-prepper"),
			project_checklist_item_deleted: __("deleted a checklist item", "project-prepper"),
			rental_created: __("created a rental", "project-prepper"),
			rental_updated: __("updated a rental", "project-prepper"),
			rental_status_changed: __("changed a rental status", "project-prepper"),
			rental_deleted: __("deleted a rental", "project-prepper"),
			schedule_created: __("added a schedule entry", "project-prepper"),
			schedule_updated: __("updated a schedule entry", "project-prepper"),
			schedule_deleted: __("deleted a schedule entry", "project-prepper"),
			team_member_created: __("added a team member", "project-prepper"),
			team_member_updated: __("updated a team member", "project-prepper"),
			team_member_deleted: __("deleted a team member", "project-prepper")
		};
