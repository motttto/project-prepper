...
<div class="wp-block-group alignfull has-surface-color has-primary-background-color has-text-color has-background" style="padding-top:64px;padding-right:clamp(20px, 4vw, 48px);padding-bottom:64px;padding-left:clamp(20px, 4vw, 48px)">
	...
	<h2 class="wp-block-heading has-text-align-center has-surface-color has-text-color has-x-large-font-size"><?php esc_html_e( 'Planning an event?', 'prepper-site' ); ?></h2>
	<!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center","textColor":"tint"} -->
	<p class="has-text-align-center has-tint-color has-text-color"><?php esc_html_e( 'Tell us what you need and when — you will hear back from us within one business day.', 'prepper-site' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons" style="margin-top:24px">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-primary-dark-color has-surface-background-color has-text-color has-background wp-element-button" href="/request/"><?php esc_html_e( 'Send a request', 'prepper-site' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
